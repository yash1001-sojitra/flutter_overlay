...
class OverlayCircleMenu extends StatefulWidget {
  const OverlayCircleMenu({Key? key}) : super(key: key);
          ...
          ? Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  width: 60,
                  margin:
                      isExpanded ? EdgeInsets.zero : const EdgeInsets.all(4),
...
class CircularMenuItem extends StatelessWidget {
  ...
  const CircularMenuItem(
      {Key? key, this.badgeLabel, this.icon, this.onTap, this.isActive})
      : super(key: key);
          ...
          Stack(
            ...
            children: [
              InkWell(
                onTap: onTap,
                child: CustomPaint(
                  size: const Size(90, 90 * 0.6179775280898876),
...
class MenuItemShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.color = const Color(0x0fffffff).withOpacity(0.9);

    Paint paint1Fill = Paint()..style = PaintingStyle.fill;
    paint1Fill.color = const Color(0xff000000).withOpacity(0.5);
